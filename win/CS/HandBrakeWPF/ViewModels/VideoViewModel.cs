    ...
    public class VideoViewModel : ViewModelBase, IVideoViewModel
    {
        ...
        public bool IsAdvancedTabOptionEnabled
        {
            get
            {
                ...
                if (this.SelectedVideoEncoder != VideoEncoder.X264 && this.SelectedVideoEncoder != VideoEncoder.X264_10 && this.SelectedVideoEncoder != VideoEncoder.H264_NVENC)
                {
                    this.UseAdvancedTab = false;
                    return false;
                }
        ...
        public bool IsLossless
        {
            get
            {
                return 0.0.Equals(this.DisplayRF) && (this.SelectedVideoEncoder == VideoEncoder.X264 || this.SelectedVideoEncoder == VideoEncoder.X264_10 || this.SelectedVideoEncoder == VideoEncoder.H264_NVENC);
            }
        }
        ...
        public string Rfqp
        {
            get
            {
                return this.SelectedVideoEncoder == VideoEncoder.X264 || this.SelectedVideoEncoder == VideoEncoder.X264_10 || this.SelectedVideoEncoder == VideoEncoder.H264_NVENC
                    || this.SelectedVideoEncoder == VideoEncoder.X265
                    || this.SelectedVideoEncoder == VideoEncoder.X265_10 || this.SelectedVideoEncoder == VideoEncoder.X265_12 || this.SelectedVideoEncoder == VideoEncoder.HEVC_NVENC ? "RF" : "QP";
            }
        }
        ...
        public string HighQualityLabel
        {
            get
            {
                return this.SelectedVideoEncoder == VideoEncoder.X264 || this.SelectedVideoEncoder == VideoEncoder.X264_10 || this.SelectedVideoEncoder == VideoEncoder.H264_NVENC ? Resources.Video_PlaceboQuality : Resources.Video_HigherQuality;
            }
        }
        ...
        public string FullOptionsTooltip
        {
            get
            {
                return this.SelectedVideoEncoder == VideoEncoder.X264 || this.SelectedVideoEncoder == VideoEncoder.X264_10 || this.SelectedVideoEncoder == VideoEncoder.H264_NVENC ? string.Format(Resources.Video_EncoderExtraArgs, this.GetActualx264Query()) : Resources.Video_EncoderExtraArgsTooltip;
            }
        }
        ...
        public void SetPreset(Preset preset, EncodeTask task)
        {
            ...
            if (preset.Task != null)
            {
                ...
                if (encoder != null)
                {
                    if (preset.Task.VideoEncoder == VideoEncoder.X264 || preset.Task.VideoEncoder == VideoEncoder.H264_NVENC || preset.Task.VideoEncoder == VideoEncoder.X264_10 
                        || preset.Task.VideoEncoder == VideoEncoder.X265 || preset.Task.VideoEncoder == VideoEncoder.X265_10 || preset.Task.VideoEncoder == VideoEncoder.X265_12 || preset.Task.VideoEncoder == VideoEncoder.HEVC_NVENC
        ...
        {
            Clipboard.SetDataObject(this.SelectedVideoEncoder == VideoEncoder.X264 || this.SelectedVideoEncoder == VideoEncoder.X264_10 || this.SelectedVideoEncoder == VideoEncoder.H264_NVENC ? this.GetActualx264Query() : this.ExtraArguments);
        }
        ...
        private void HandleEncoderChange(VideoEncoder selectedEncoder)
        {
            ...
            this.DisplayOptimiseOptions = this.SelectedVideoEncoder == VideoEncoder.X264 || this.SelectedVideoEncoder == VideoEncoder.X264_10 || this.SelectedVideoEncoder == VideoEncoder.H264_NVENC ||
                                          this.SelectedVideoEncoder == VideoEncoder.X265 || this.SelectedVideoEncoder == VideoEncoder.X265_10 || this.SelectedVideoEncoder == VideoEncoder.X265_12 || this.SelectedVideoEncoder == VideoEncoder.HEVC_NVENC ||
            ...
            this.DisplayTurboFirstPass = selectedEncoder == VideoEncoder.X264 || selectedEncoder == VideoEncoder.X264_10 || selectedEncoder == VideoEncoder.H264_NVENC ||
                                         selectedEncoder == VideoEncoder.X265 || selectedEncoder == VideoEncoder.X265_10 || selectedEncoder == VideoEncoder.X265_12 || selectedEncoder == VideoEncoder.HEVC_NVENC;
            ...
            this.DisplayProfileControl = this.SelectedVideoEncoder == VideoEncoder.X264
                                         ...
                                         || this.SelectedVideoEncoder == VideoEncoder.H264_NVENC
                                         || this.SelectedVideoEncoder == VideoEncoder.X265
                                         || this.SelectedVideoEncoder == VideoEncoder.X265_10
                                         || this.SelectedVideoEncoder == VideoEncoder.X265_12
                                         || this.SelectedVideoEncoder == VideoEncoder.HEVC_NVENC
